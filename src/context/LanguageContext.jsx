...
export const translations = {
  en: {
    ...
    progSmartBoardsName: "Smart Boards Solutions",
    progSmartBoardsDuration: "1-3 days",
    progSmartBoardsAudience: "Students & Teachers",
    progSmartBoardsFormat: "Practical workshop",
    progSmartBoardsDesc: "Using interactive smart boards for teaching, collaboration, presentations, and digital learning. Participants learn practical tools that make lessons more engaging and productive.",
    ...
    edtechStoriesSub: "Video testimonials from students and institutions.",
    ...
    rentalsEquip5Name: "Lighting Equipment",
    rentalsEquip6Name: "Lighting Equipment",
    rentalsEquip7Name: "Video-Conferencing Equipment",
    rentalsEquip8Name: "Mounts",
    rentalsEquip9Name: "Interactive Flat Panel",
    rentalsEquip10Name: "LED Screens",
    rentalsEquip11Name: "Digital Signage",
    rentalsSpecsLabel: "Specs:",
    rentalsUseCasesLabel: "Use Cases:",
    rentalsGalleryEyebrow: "Event Gallery",
    rentalsGalleryHeading: "Audio Visual & Video Conferencing Solutions in Action",
    ...
    ticketSubmitError: "We could not submit your ticket. Please try again or contact support directly.",
  ...
  fr: {
    ...
    progSmartBoardsName: "Solutions de Tableaux Interactifs",
    progSmartBoardsDuration: "1-3 jours",
    progSmartBoardsAudience: "Élèves et Enseignants",
    progSmartBoardsFormat: "Atelier pratique",
    progSmartBoardsDesc: "Utilisation de tableaux interactifs pour l'enseignement, la collaboration, les présentations et l'apprentissage numérique. Les participants découvrent des outils pratiques pour rendre les cours plus engageants et productifs.",
    ...
    rentalsEquip5Name: "Équipement d'Éclairage",
    rentalsEquip6Name: "Équipement d'Éclairage",
    rentalsEquip7Name: "Équipement de Vidéoconférence",
    rentalsEquip8Name: "Supports",
    rentalsEquip9Name: "Écran Plat Interactif",
    rentalsEquip10Name: "Écrans LED",
    rentalsEquip11Name: "Affichage Numérique",
    ...
    supportFieldPriority: "Priorité",
    supportPriorityLow: "Faible",
    supportPriorityMedium: "Moyenne",
    supportPriorityHigh: "Élevée",
    ticketSubmitError: "Nous n'avons pas pu soumettre votre ticket. Veuillez réessayer ou contacter directement l'assistance.",
