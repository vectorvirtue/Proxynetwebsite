...
export const translations = {
  en: {
    ...
    cs12Excerpt:
      "Full Yealink MVC860 system installed at PIL — MCore Pro, RCH40, MSpeaker, and MTouch all connected. System configuration pending client Microsoft Teams Rooms licence.",
  ...
  fr: {
    ...
    cs12Excerpt:
      "Système Yealink MVC860 entièrement installé chez PIL — MCore Pro, RCH40, MSpeaker et MTouch tous connectés. Configuration en attente de la licence Microsoft Teams Rooms du client.",
