...
export const translations = {
  en: {
    ...
    cs3Excerpt:
      "A multi-site digital display rollout across GTBank Gambia branches with centralised content management.",
    ...
    // FAQs data
    faq1q: "How long does onboarding take after a project is delivered?",
    faq1a: "Onboarding typically takes 1–5 business days depending on the complexity of the solution. Your account manager will walk you through the process and provide all necessary documentation.",
    faq2q: "Will I receive training on the systems installed?",
    faq2a: "Yes. All deployments include a handover session and user training. We also provide written guides and video walkthroughs where applicable.",
    faq3q: "What should I do if my system goes down outside business hours?",
    faq3a: "Call our 24/7 support line on +234 703 264 7755 or send a WhatsApp message. Critical issues are escalated immediately regardless of the time.",
    faq4q: "How do I raise a support ticket?",
    faq4a: "Use the ticket form on this page, email info@proxynetgroup.com, or call our support line. All tickets are logged and tracked through to resolution.",
    faq5q: "Can Proxynet support systems not originally installed by you?",
    faq5a: "Yes, in many cases. Contact our support team with details of your existing infrastructure and we will assess whether we can provide support.",
    faq6q: "Are support services included in my contract?",
    faq6a: "This depends on your service agreement. Most clients are on a managed services contract that includes defined support hours. Contact your account manager for details.",
    faq7q: "How do I request an invoice or receipt?",
    faq7a: "Email info@proxynetgroup.com with your company name and the relevant project or service period. We will issue documentation within 2 business days.",
    faq8q: "How do I update my contact details on file?",
    faq8a: "Email info@proxynetgroup.com with your updated details and your account manager will update your records.",
    faq9q: "Who is my dedicated account manager?",
    faq9a: "Your account manager is assigned at the start of your engagement. If you are unsure, email info@proxynetgroup.com and we will connect you with the right person.",
  },
  fr: {
    // Nav
    ...
    cs3Excerpt:
      "Un déploiement d'affichage numérique multi-sites dans les agences GTBank Gambie avec gestion centralisée du contenu.",
