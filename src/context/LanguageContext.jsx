...
export const translations = {
  en: {
    ...
    supportFaq3a: "Call our 24/7 support line on +234 903 182 9347 or send a WhatsApp message. Critical issues are escalated immediately regardless of the time.",
    ...
    faq8a: "Call our 24/7 support line on +234 903 182 9347 or send a WhatsApp message to the same number. Critical issues are escalated immediately regardless of the time. Managed services clients have guaranteed response times per their SLA.",
    ...
    proxynetUniluminExpVenue: "Lagos",
    ...
    uniluminLedTrainingVenue: "Lagos",
  ...
  fr: {
    ...
    supportFaq3a: "Appelez notre ligne de support 24h/24 au +234 903 182 9347 ou envoyez un message WhatsApp. Les problèmes critiques sont escaladés immédiatement quelle que soit l'heure.",
