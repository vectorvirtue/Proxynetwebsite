 ...
 */
export default function SectionBlobs({ variant = "light", opacityScale = 1 }) {
  const isLight = variant === "light";

  const c1 = isLight
    ? `rgba(0,111,180,${0.08 * opacityScale})`
    : `rgba(255,255,255,${0.06 * opacityScale})`;

  const c2 = isLight
    ? `rgba(70,195,242,${0.07 * opacityScale})`
    : `rgba(255,255,255,${0.04 * opacityScale})`;
