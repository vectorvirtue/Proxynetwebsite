...
import { Menu, X, ChevronDown, Search, Shield, Wifi, Server, Globe, Headphones, BarChart2, TvMinimal, Monitor, GraduationCap } from 'lucide-react'
...
items: [
{ icon: <Server size={18} />, label: t.systemsIntegration, href: '/solutions/systems-integration' },
{ icon: <Globe size={18} />, label: t.enterpriseNetworking, href: '/solutions/enterprise-networking' },
],
},
{
category: t.cybersecurity,
items: [
{ icon: <Shield size={18} />, label: t.itSecurity, href: '/solutions/it-security' },
{ icon: <Wifi size={18} />, label: t.intrusionDetection, href: '/solutions/intrusion-detection' },
{ icon: <BarChart2 size={18} />, label: t.logsMonitoring, href: '/solutions/monitoring' },
],
},
{
category: t.managedServices,
items: [
{ icon: <Headphones size={18} />, label: t.remoteAccess, href: '/solutions/remote-access' },
{ icon: <Shield size={18} />, label: t.firewallSecurity, href: '/solutions/firewall' },
{ icon: <Server size={18} />, label: t.vpn, href: '/solutions/vpn' },
],
},
{
category: t.softwareSolutions,
items: [
{ icon: <BarChart2 size={18} />, label: t.customDev, href: '/solutions/custom-software' },
{ icon: <Globe size={18} />, label: t.webApps, href: '/solutions/web-apps' },
{ icon: <Headphones size={18} />, label: t.mobileApps, href: '/solutions/mobile-apps' },
{ icon: <Server size={18} />, label: t.erp, href: '/solutions/erp' },
                    ...
                    {solutions.map((group) => (
                      <div key={group.category} className={styles.megaGroup}>
                        ...
                        {group.items.map((item) => (
                          <Link key={item.label} to={item.href} className={styles.megaItem}>
...
{mobileOpen && (
  ...
  >
    <div className={styles.mobileHeader}>
      ...
      <button onClick={() => setMobileOpen(false)} aria-label="Close menu" className={styles.closeBtn}>
        <X size={24} />
      </button>
    </div>
                ...
                {mobileExpanded && (
                  ...
                  >
                    {solutions.flatMap((g) =>
                      g.items.map((item) => (
                        <li key={item.label}>
                          <Link to={item.href} className={styles.mobileSubLink}>
